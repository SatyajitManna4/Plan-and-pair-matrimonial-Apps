...
import com.example.planpair.adapters.MatchedUserAdapter;
...
public class ChatListActivity extends AppCompatActivity {
    ...
    private MatchedUserAdapter adapter;
    private List<MatchedUser> userList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MatchedUserAdapter(userList, this);
        matchedUsersRecyclerView.setAdapter(adapter);
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            // Handle unauthenticated user case (optional)
            finish();
        }
    }
        ...
        db.collection("Matches")
                ...
                .addOnSuccessListener((QuerySnapshot queryDocumentSnapshots) -> {
                    ...
                    for (DocumentSnapshot doc : queryDocumentSnapshots) {
                        ...
                        // Assuming 'name' field exists in the matched document
                        String name = doc.contains("username") ? doc.getString("username") : "Unknown";
                        userList.add(new MatchedUser(userId, name));
                    }
                    adapter.notifyDataSetChanged();
                })
                .addOnFailureListener(e -> {
                    // Optional: log error or show a Toast message
                    e.printStackTrace();
                });
    }
}
